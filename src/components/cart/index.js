...
const CartComponent = () => {
    ...
    const obj = { "MerchantCode": "M030856", "OrderNo": "DW0001", "CustomerId": "supagorn", "Amount": 2000, "ChannelCode": "internetbank_scb", "Currency": "764", "RouteNo": 1, "IPAddress": "183.88.68.171", "ApiKey": "v06M0eQtSuk73HmQZ6QNiPGXyhGwS4Lzk76wuHT4GBtdUBpvbv6n2P18pLsPxtvD", "CheckSum": "0097c2639982996fdd2fe841bd120ea6" }
...
const EnhancedCartComponent = withFormik({
    ...
    handleSubmit: (values) => {
        ...
        function md5Helper(data) {
            ...
            txt += "ipgv7ZVSVnZ6RFLOWGWnhly6iSl4w8xmaRg3PsX5GnTuQ1QPpYivGBnF3DSpt3T851x1klEEQoywSjCEodcYu46K6YyGBJsT9Qcj8Z2beA1bDIgDroymDMpLYEQJ9kCtzVOQukf6zQoU4vj2GI5PygYEe3fAkq1kksM9S"
            console.log("I got this:", txt)
            ...
            .then(res => {
                ...
                axios.post(`https://asia-east2-digitalwish-sticker.cloudfunctions.net/orders`, data)
                    .then(res => {
                        ...
                        const notChillPayAtAll = JSON.stringify(dataPostChillpay)
